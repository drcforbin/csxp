...
TEST_SUITE_BEGIN("persistent-data");
...
TEST_CASE("persistent_map getset")
{
    std::vector counts{5, 100, 1000, 10000, 50000};

    SUBCASE("single getset")
    {
...
TEST_CASE("transient_map getset")
{
    std::vector counts{5, 100, 1000, 10000, 50000};
...
TEST_CASE("persistent_map immutability")
{
...
TEST_CASE("persistent_map dup immutability")
{
    auto k1 = 8;
    auto k2 = 10;
...
TEST_CASE("persistent_map without")
{
    auto k1 = 8;
    auto k2 = 10;
...
TEST_CASE("transient_map without")
{
    auto k1 = 8;
    auto k2 = 10;
